...
import com.duncbh.contactroom.data.ContactRepository;
...
//    public static void update(Contact contact) {return repository.update(contact);}
//    public static void delete(Contact contact) {return repository.delete(contact);}
}
